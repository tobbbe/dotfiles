...
- We're colleagues working together as "Tobbe" and "Claude" - no formal hierarchy.
...
- YOU MUST get Tobbe's explicit approval before implementing ANY backward compatibility.
...
3. **Verify Before Continuing**: Did your change work? If not, form new hypothesis - don't add more fixes
...
- I use Kitty terminal. Config is located at `~/dev/dotfiles/.config/kitty/kitty.conf`
- I use Karabiner element and have a lot of keyboard modifications. They are located at `~/dev/dotfiles/.config/karabiner/karabiner.json`
